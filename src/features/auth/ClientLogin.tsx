...
// import ClientLogoDark from "../../assets/SampleClinetLogo.png"
// import ClientLogoDark from "../../assets/Sample CAFirm Logo.png"
...
const ClientLogin = () => {
  ...
  const from = location.state?.from?.pathname || "/view-clients"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4 zato-login-bg">
      <div className="dark:bg-gray-800 rounded-md absolute top-10 left-10 w-24">
        <img src={ClientLogoDark} alt="Zato Logo" width="100%" height="100%" className="login-logo rounded-full"  />
        {/* <ClientLogo /> */}
      </div>
      <div className="flex flex-col items-center" style={{ width: "35%" }}>
        <h1 className="form-decision">Guiding Growth, Empowering Compliance</h1>
        <p className="text-gray-900 dark:text-gray-400 mb-4">Shaping Smarter Businesses for a Smarter World</p>
