...
import { Card, Typography, Tabs, Form, Switch, Select, Button, Divider, Row, Col, message, Input, Upload, Space, Tag } from "antd"
...
//     key: "aliasName",
//     render: () => (
//       <Input placeholder="Alias Name" onChange={(e) => console.log(e.target.value)} />
//     )
//   },
//   {
//     title: "Account Name",
...
//           <select name="questionnaire" id="" style={{ width: "100%", border: "1px solid #0f5b6d", outline: "none", borderRadius: "4px", padding: "0.3rem", color: "#0f5b6d", fontSize: "0.8rem" }}>
//             <option value="">Select Account Name</option>
//             <option value="questionnaire_one">Account 1</option>
//             <option value="questionnaire_two">Account 2</option>
//             <option value="questionnaire_three">Account 3</option>
//             <option value="questionnaire_four">Account 4</option>
//             <option value="questionnaire_five">Account 5</option>
//           </select>
//         </div>
//       </div>
//     )
...
//   {
//     title: "Workpapers",
//     dataIndex: "work_papers",
//     key: "workPapers",
//   }
// ]
// const accountCodeData = [
//   {
//     id: "1",
//     aliasName: "Alias 1",
...
//     accountNumber: "654321",
//     workPapers: "Workpapers 8",
//   },
// ]
const Settings: React.FC<SettingsProps> = ({ visible, onCancel }) => {
  ...
  return (
    <div className={`space-y-6 ${user_control?.role === "client" ? "p-4 md:p-6" : ""}`}>
      <Title level={3} className="m-0">
        Settings
      </Title>
      <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
        <Card bordered={false} className="rounded-xl shadow-sm" style={{ width: '60%' }}>
