...
import { Typography, Tabs, Form, Switch, Select, Button, message, Input, Modal } from "antd"
import { BellOutlined, LockOutlined, SaveOutlined, UserOutlined, GlobalOutlined } from "@ant-design/icons"
...
const Settings: React.FC<SettingsProps> = ({ visible, onCancel , onSave, defaultCompany }) => {
  ...
  return (
    ...
    >
       ...
       <h6 className="mb-1" style={{fontSize:"12px"}}>Company</h6>
        <Select
        ...
        <p className="mt-2" style={{fontSize:"11px"}}>Note : You can only proceed after selecting a company</p>
      </div>
